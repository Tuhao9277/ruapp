...
interface T {
 ...
 class Index extends Taro.Component<K, T> {
  ...
  render() {
    const {openid,password} = this.state
    return (
      <View>
        ...
        <View className="thirdAuth" >
          ...
          <Image onClick={this.showToast.bind(this)} style="width:30px;height:30px;margin-right:10px"  src={taobao}  />
          <Image onClick={this.showToast.bind(this)} style="width:30px;height:30px"  src={Alipay}  />
          </View>
        </View>
      </View>
    );
